    ...
    () => [
      {
        ...
        flex: 1,
        minWidth: 180,
        valueGetter: (params) => formatName(params.row.coach) || params.row.coachId,
      },
      {
        field: 'athlete',
        ...
        flex: 1,
        minWidth: 180,
        valueGetter: (params) => formatName(params.row.athlete) || params.row.athleteId,
      },
      {
        field: 'startDate',
        ...
        flex: 1,
        minWidth: 150,
        valueFormatter: (params) => (params.value ? fmtDate(params.value as string) : t('common.messages.no_value')),
      },
      {
        field: 'endDate',
      ...
      },
      {
        ...
        flex: 1,
        minWidth: 200,
        valueGetter: (params) => params.value || t('athletes.table.no_note'),
      },
      {
        field: 'updatedAt',
