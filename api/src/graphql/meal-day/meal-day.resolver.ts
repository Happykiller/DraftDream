...
import {
  ...
  MealDayListGql,
  UpdateMealDayInput,
} from '@graphql/meal-day/meal-day.gql.types';
import { mapMealDayUsecaseToGql } from '@graphql/meal-day/meal-day.mapper';
import { mapMealUsecaseToGql } from '@graphql/meal/meal.mapper';
