...
export type CreateProgramUsecaseDto = Omit<CreateProgramServiceDto, 'slug'> & { session: UsecaseSession };
...
export type UpdateProgramUsecaseDto = Omit<UpdateProgramServiceDto, 'slug'> & { session: UsecaseSession };
