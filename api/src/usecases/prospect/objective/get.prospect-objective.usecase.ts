...
import { GetProspectObjectiveUsecaseDto } from './prospect-objective.usecase.dto';

export class GetProspectObjectiveUsecase {
  constructor(private readonly inversify: Inversify) { }

  async execute(dto: GetProspectObjectiveUsecaseDto): Promise<ProspectObjective | null> {
    try {
